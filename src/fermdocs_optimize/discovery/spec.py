...
class DiscoveryRound(BaseModel):
    ...
    oracle_peak_rmse: float                        # g/L, agent-model vs held-out peak P
    oracle_peak_r2: float                          # held-out peak R^2 (the gate)
    oracle_traj_r2: float                          # trajectory P R^2 on held-out batches
